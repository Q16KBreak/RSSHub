...
7. Append the query string \`?mode=full\` to any URL to retrieve detailed descriptions. By default, it returns \`6\` entries, but this can be adjusted using the \`limit\` query string, e.g., \`/nyaa/user/VCB-Studio?mode=full&limit=10\`.
